  ...
  return (
      <Sidebar variant="inset">
        ...
        <SidebarFooter className="p-2">
          {/* Upstream's utility strip, minus <JoinDiscordCard /> — the
              "Join our Discord" promo stays disabled on this fork, so the
              help trigger is the only occupant and `justify-end` holds it
              right-aligned. */}
